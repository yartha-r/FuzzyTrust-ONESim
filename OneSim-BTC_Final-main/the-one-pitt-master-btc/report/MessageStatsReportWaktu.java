 ...
 */
public class MessageStatsReportWaktu extends Report implements MessageListener {
	private Map<String, Double> creationTimes;
	private List<Double> latencies;
	private List<Integer> hopCounts;
	private List<Double> msgBufferTime;
	private List<Double> rtt; // round trip times
        private Map<DTNHost, List<Tuple<Double,Double>>> timeInfo;
	 ...
	 * Constructor.
	 */
	public MessageStatsReportWaktu() {
		init();
	}
