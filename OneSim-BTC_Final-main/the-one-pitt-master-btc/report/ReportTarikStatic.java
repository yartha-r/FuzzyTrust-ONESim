...
//            if (h.toString().startsWith("Ver")) {
//                cetak += h +"\n";
//                cetak += "Encounter count\n";
//                for (DTNHost mssgr : ((DecisionEngineRouter) h.getRouter()).getEncounterCount().keySet()) {
//                    cetak += mssgr+" : "+((DecisionEngineRouter) h.getRouter()).getEncounterCount().get(mssgr)+"\n";
//                }
//                
//            }
        }
